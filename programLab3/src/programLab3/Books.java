...
public class Books implements Serializable, java.lang.Comparable<Books>  {
	...
	public boolean equals(Object obj)
	{
		...
		if(this.autorFirstName == null)
		{
			if(book.autorFirstName != null)
			{
				return false;
			}
		}
		else if(!this.autorFirstName.equals(book.autorFirstName))
		{
			return false;
		}
		
		if(this.autorLastName == null)
		{
			if(book.autorLastName != null)
			{
				return false;
			}
		}
		else if(!this.autorLastName.equals(book.autorLastName))
		{
			return false;
		}
		return true;
	...
	{
		int result = this.title.compareTo(books.title);
